        ...
        <div className="relative w-full sm:w-[260px]" ref={menuRef}>
          ...
          {showContact && (
            <div className="absolute bottom-full left-0 mb-3 bg-white w-full sm:w-[400px] rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.25)] p-3 border border-slate-100 z-50 flex flex-col gap-2 animate-in fade-in slide-in-from-bottom-2 duration-200">
              <a href="tel:01718955467" className="flex items-center gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors bg-white group border border-transparent hover:border-slate-100">
                ...
                <div className="flex flex-col text-left">
                  ...
                  <span className="text-slate-500 font-medium text-[14px]">Dial ০১৭১৮৯৫৫৪৬৭</span>
                </div>
              </a>

              <a href="https://wa.me/8801718955467" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors bg-white group border border-transparent hover:border-slate-100">
