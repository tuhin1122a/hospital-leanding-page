            ...
            <div className="relative w-[280px] sm:w-[240px]" ref={menuRef}>
               ...
               <AnimatePresence>
                  {showContact && (
                     ...
                     >
                        <a href="tel:01718955467" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors bg-white group border border-transparent hover:border-slate-100">
                           ...
                           <div className="flex flex-col text-left">
                              ...
                              <span className="text-slate-500 font-medium text-[12px]">০১৭১৮৯৫৫৪৬৭</span>
                           </div>
                        </a>

                        <a href="https://wa.me/8801718955467" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 transition-colors bg-white group border border-transparent hover:border-slate-100">
