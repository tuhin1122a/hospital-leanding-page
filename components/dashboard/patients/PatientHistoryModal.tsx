...
export default function PatientHistoryModal({ show, onClose, patient, history, isLoading, onAddRecord }: PatientHistoryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.95, y: 30 }} animate={{ opacity: 1, scale: 1, y: 0 }} className="relative w-full max-w-5xl bg-card border border-border rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[85vh]">
        <div className="w-full md:w-80 bg-muted/30 border-r border-border p-8 flex flex-col items-center">
          <div className="w-24 h-24 rounded-xl bg-primary flex items-center justify-center text-background text-4xl font-black mb-6 shadow-xl shadow-primary/20">{patient?.name[0]}</div>
