...
export default function MedicalFacilities() {
  const facilities = [
    ...
    },
    {
      ...
      image: '/hero-doctor.png', // Re-using doctor as fallback/atmosphere
    ...
    },
    {
      ...
      image: '/dashboard/dashboard-preview.png', // Re-using visual as placeholder if needed
    ...
    <section className="py-24 bg-[#f8faff] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {facilities.map((f, i) => (
            <div key={i} className="bg-white rounded-[40px] shadow-[0_30px_70px_-15px_rgba(0,0,0,0.06)] overflow-hidden border border-white hover:shadow-2xl transition-all duration-700 group flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2 p-8 flex flex-col justify-center space-y-4">
                ...
                <button className="text-[13px] font-black text-[#1a4bde] uppercase tracking-[0.1em] border-b-2 border-[#1a4bde]/20 hover:border-[#1a4bde] transition-all w-fit cursor-pointer translate-y-2">
                  Learn about Tech
                </button>
              </div>
            </div>
