  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-card-foreground tracking-tighter">{t('Medical Faculty')}</h1>
          <p className="text-muted-foreground font-medium text-lg mt-1">{t('Manage specialist rosters and clinical schedules')}</p>
        </div>
        <Button className="h-14 px-8 rounded-2xl bg-primary hover:bg-primary/90 text-background font-black shadow-xl shadow-primary/20 transition-all">
          <Plus size={20} className="mr-2" /> {t('Register New Doctor')}
        </Button>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-6">
        <div className="relative flex-grow w-full">
           ...
           <input 
            type="text" 
            placeholder={t("Search by name, specialty, or ID...")} 
